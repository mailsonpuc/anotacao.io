...
//end 2
document.getElementById("encerramento2").innerHTML=`<del>Faltam <i class="#e040fb purple accent-2">${encerramento1(new Date('2025,04,20'), new Date())} DIAS</i> Tarefa 2 (Etapa 2)</del>`

//end 3
document.getElementById("encerramento3").innerHTML=`<del>Faltam <i class="#e040fb purple accent-2">${encerramento1(new Date('2025,05,25'), new Date())} DIAS</i> Tarefa 3 (Etapa 3)</del>`
