...
//end 1 dia/mes/ano
document.getElementById("encerramento1").innerHTML=`Faltam <i class="#e040fb purple accent-2">${encerramento1(new Date('2024,08,26'), new Date())} DIAS</i> Tarefa 1 (Etapa 1)`
