...
//end 2
document.getElementById("encerramento2").innerHTML=`Faltam <i class="#e040fb purple accent-2">${encerramento1(new Date('2024,04,24'), new Date())} DIAS</i> para Etapa 2:

Projeto dos requisitos e de artefatos do sistema`

//end 3
document.getElementById("encerramento3").innerHTML=`Faltam <i class="#e040fb purple accent-2">${encerramento1(new Date('2024,02,06'), new Date())} DIAS</i> para Etapa 3:

Desenvolvimento da solução (Parte 1)`

//end 4
document.getElementById("encerramento4").innerHTML=`Faltam <i class="#e040fb purple accent-2">${encerramento1(new Date('2024,06,24'), new Date())} DIAS</i> para Etapa 4:
